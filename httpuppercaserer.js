...
// incoming POST body characters to upper -
...
// request and response objects, it will be much easier
// if you do .

// There are a number of different packages in npm that you can use to "transform"
// stream data as it 's passing through. For this exercise the  
...
// designed to work much like Array# map() but
// for streams:
...
// String(
//         if it isn 't already), the characters are reversed and the result  
//         is passed through to outStream.So we 've made a chunk character reverser!  
//         Remember though that the chunk size is determined up - stream and you have little control over it
//         for incoming data.
...
//         directory and copy the entire directory
//         for the module you want to use from inside the learnyounode installation directory:

//         file: ///home/ubuntu/.nvm/versions/node/v4.3.2/lib/node_modules/learnyounod  
//         e / node_modules / through2 - map

//         Documentation
//         for through2 - map has been installed along with learnyounode on your system and you can read them by pointing your browser here:
