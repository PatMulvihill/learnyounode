...
// Because we need to create an HTTP server
// for this exercise rather than a
...
// for each
// connection received by your server.The callback
// function has the
// signature:
...
// for this request.request is used to fetch
// properties, such as the header and query - string from the request
// while
// response is
// for sending data to the client, both headers and body.
...
// The fs core module also has some streaming APIs
// for files.You will need
