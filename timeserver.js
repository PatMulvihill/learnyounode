...
// For this exercise we 'll be creating a raw TCP server. There'
// s no HTTP
...
// server triggers another call to the callback.The callback
// function has
// the signature:
...
// Or,
// if you want to be adventurous, use the strftime package from npm.The
// strftime(fmt, date)
// function takes date formats just like the unix date
// command.You can read more about strftime at: [https: //github.com/samsonjs/strftime](https://github.com/samsonjs/strftim  
//     e)
...
var server = net.createServer(function(socket) {
    ...
    var writeString = '' + fullYear + '-' + month + '-' + day + ' ' + hours + ':' + mins + '\n';

    socket.end(writeString);
});
